...
def showG(test_A, test_B, path_A, path_B, batchSize,typer,iterations):
    figure_A = np.stack([
        test_A,
...
def showG_mask(test_A, test_B, path_A, path_B, batchSize,typer,iterations):
    figure_A = np.stack([
        test_A,
...
def showG_eyes(test_A, test_B, bm_eyes_A, bm_eyes_B, batchSize, typer, iterations):
    figure_A = np.stack([
        (test_A + 1)/2,
        bm_eyes_A,
